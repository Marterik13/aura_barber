<nav x-data="{ open: false }" class="bg-[#111] border-b border-gray-800">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center h-full">
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="text-gray-300 hover:text-[#D4AF37] h-16">
                        {{ __('Panel') }}
                    </x-nav-link>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:text-[#D4AF37] hover:bg-gray-900 focus:outline-none transition duration-150 ease-in-out">

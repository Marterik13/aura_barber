<nav class="fixed top-0 z-40 w-full bg-[#111] border-b border-gray-800">
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        <!-- Sidebar toggle button -->
        <button @click="sidebarOpen = !sidebarOpen" type="button" class="sm:hidden text-gray-400 bg-transparent hover:bg-gray-900 focus:ring-4 focus:ring-[#D4AF37] font-medium leading-5 rounded-base text-sm p-2 focus:outline-none transition-all">
